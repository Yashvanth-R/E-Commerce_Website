...
const Navbar = () => {
const user = false; // Change this to false to simulate a logged-out state
const isAdmin = true; // Change this to true to simulate an admin user
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 boredr-b border-emerald-800">
        <div className="container mx-auto px-4 py-3">
            ...
            <nav className="flex flex-wrap items-center gap-4">
                ...
                {user ? (
                    <button className="bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md flex items-center trsansition duration-300 ease-in-out">
                        <LogOut size={18} />
                    ...
                    <>
                        ...
                        <Link to={"/login"} className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-md flex items-center transition duration-300 ease-in-out">
